module.exports = {
  ...
  plugins: {
    ...
    'postcss-pxtorem': {
      ...
      // 但vent建议设置为37.5，因为vent是基于375px宽度的设计稿写的。据此，使用设计稿时，要把设计稿的尺寸除以二。但这样的话，vent组件就会变得很小。
      // 需求：vent样式按照37.5来转换；如果是设计稿的样式，按照75来转换。
      ...
      rootValue (obj) {
        ...
        const { file } = obj
        // console.log(file)
        // 如果file中含有vent样式，则按照37.5的rootValue来处理，否则75
